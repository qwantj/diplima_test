...
*MM* – запоминающая среда (***m****emory* ***m****edium*); *CU* – устройство управления (***c****ontrol* ***u****nit*); *A* – адрес; *DI* – данные входные; *WR/RD* – управляющий сигнал ″запись/ считывание″;  *MS* – управляющий сигнал ″выбор ЗУ″;  *DO* – данные выходные; *m –* число разрядов кода адреса;  *n –* разрядность ЗУ
...
|  |  |  |  |
| --- | --- | --- | --- |
| Режим  работы ЗУ | Управляющий  сигнал | | Примечание |
| *MS* | *WR/RD* |
| Хранение | | 1 | X | Отсутствует или малое потребление мощности. X – безразличное состояние |
