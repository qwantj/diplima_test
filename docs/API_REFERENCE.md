...
Отправляется каждые 2 секунды (длительность окна). Содержит результаты работы ML модели и полные топы.
...
### 3.3 Включение/Выключение BPF фильтра (Auto-Block)
```json
{
  "type": "cmd",
  "data": {
